...
hn is a single binary. It speaks to hackernews over plain HTTPS,
shapes the responses into clean records, and gets out of your way. There is
nothing to sign up for and nothing to run alongside it.

## How it is built

- A **library package** (`hackernews`) holds the HTTP client and the typed
...
hn is a read-only client over data hackernews already serves
