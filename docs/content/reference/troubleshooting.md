...
Most of these come down to network reality or how hackernews serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

hackernews rate-limits like any public site. hn already paces
...
Where a surface is gated, hn reads a cookie or token you supply
...
`hn`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what hn actually did
